        ...
        <div className='flex justify-between items-center py-5 w-full px-2 xl:w-9/12 md:w-11/12 md:mx-auto'>
            ...
            <div className='items-center gap-x-14 hidden md:flex'>
                <ul className='flex gap-x-8'>
                    ...
                    <li><NavLink to="/article" className="px-3 text-sm py-1.5 bg-white/10 border border-slate-200 text-slate-900 lg:text-white rounded-2xl" >Article</NavLink></li>
                    <li><NavLink to="/property" className="px-3 text-sm py-1.5 bg-white/10 border border-slate-200 text-slate-900 lg:text-white rounded-2xl" >Property</NavLink></li>
                </ul>
